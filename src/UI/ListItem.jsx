...
const ListItem = ({ label, text }) => {
  ...
  return (
    <div className="flex flex-col ps-2 items-end justify-between gap-4 lg:gap-2 be-vietnam-pro-medium">
      <li
      ...
      <p className="lg:ps-22 be-vietnam-pro-regular text-sm lg:text-base text-(--DarkGrayishBlue) leading-7 lg:leading-8 pe-2">
        {text}
      </p>
    </div>
  );
